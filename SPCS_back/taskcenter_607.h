...
private:
    ...
    std::map<int,std::vector<int> >         m_PD;
    std::map<int ,std::pair<short ,short> > m_RCN;
    std::map<int,CVTS::SPoint>              m_array_data;
    ...
    TDATA                                   m_task_org_data;
    std::map<int,TDATA>                     m_cfgMP_data;
    std::map<int,TDATA>                     m_cfgM_MP_data;
    std::map<int,double>                    m_delt_mag;          ////加权值
    std::map<QString,std::pair<double,double> > m_base_mp;       ///基准值

    Task_Cmp                                m_temp_cal_data;     ///中间校准文件

    double                                  m_sweepshelf_time;
    double                                  m_elesw_time;
    double                                  m_multisw_time;
    double                                  m_wave_time;
    double                                  m_pnacollect_time;

    int                                     m_cfg_mp_times;
    int                                     m_cfg_m_mp_times;

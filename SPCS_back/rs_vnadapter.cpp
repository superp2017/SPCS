                            ...
                            double path4_de, double path4_wi)
{
    ...
    if(iseable)
    {
        ...
        //channel 2
        char *ret = (path2 ? "ON":"OFF");
        sprintf(m_buffer,"EUN:PMOD1 %s\n", ret);
        viPrintf(m_vi,m_buffer);
...
void RS_VNAdapter::set_trace_S11()
{
    ...
    /// 设置端口通道1 S11
    viPrintf (m_vi, "CALC1:PAR:SDEF 'ch1_S11','S11'\n");
...
void RS_VNAdapter::set_trace_S22()
{
    connect();
    /// 设置端口通道1 S22
    viPrintf (m_vi, "CALC1:PAR:SDEF 'ch1_S22','S22'\n");
    /// 设置显示窗口
...
void RS_VNAdapter::set_trace_S21()
{
    connect();
    /// 设置端口通道1 S21
    viPrintf (m_vi, "CALC1:PAR:SDEF 'ch1_S21','S21'\n");
    /// 设置显示窗口
...
void RS_VNAdapter::set_trace_S12()
{
    connect();
    /// 设置端口通道1 S21
    viPrintf (m_vi, "CALC1:PAR:SDEF 'ch1_S12','S12'\n");
    /// 设置显示窗口
...
void RS_VNAdapter::set_trace_S31()
{
    connect();
    /// 设置端口通道1 S31
    viPrintf (m_vi, "CALC1:PAR:SDEF 'ch1_S31','S31'\n");
    /// 设置显示窗口
...
void RS_VNAdapter::set_trace_S33()
{
    connect();
    /// 设置端口通道1 S33
    viPrintf (m_vi, "CALC1:PAR:SDEF 'ch1_S33','S33'\n");
    /// 设置显示窗口
